...
<%
	...
	try 
	{
		...
		ResultSet rs = st.executeQuery("select * from recuriter where password='" + currentPassword + "'");
		...
		if (password.equals(currentPassword)) 
		{
			...
			int i = st.executeUpdate("update recuriter set password='" + newPassword + "' where recuriter_id='" + id + "'");
