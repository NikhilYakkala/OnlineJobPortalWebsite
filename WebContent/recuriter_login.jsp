...
<h3>Welcome to Recuriter Login Page</h3>
	...
	<form name="form" action="RecuriterLogin" method="post" onsubmit="return validateData()" >
	
		<label> Role : </label> <input type="text" name="recuriterrole" value="Recuriter" readonly="readonly"> <br> <br>
		 
		<label> Enter Username : </label> <input type="text" name="recuritername"> <br> <br>

		<label> Enter Password : </label> <input type="password" name="recuriterpassword"> <br> <br> 
		
		&nbsp; &nbsp; <input type="Submit"> &nbsp; &nbsp; <input type="reset"> &nbsp; &nbsp;
		
		<b align="center"> <label> New User? </label> <a href ="recuriter_registration.jsp"> <label> Register Here </label> </a></b>
		</div>
		</body>
