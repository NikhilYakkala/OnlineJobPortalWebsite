...
<h3>Welcome to User Login Page</h3>
	...
	<form name="form" action="UserLogin" method="post" onsubmit="return validateData()" >
		...
		<label> Role : </label> <input type="text" name="userrole" value="User" readonly="readonly"> <br> <br>
		 
		<label> Enter Username : </label> <input type="text" name="username"> <br> <br>

		<label> Enter Password : </label> <input type="password" name="userpassword"> <br> <br> 
		
		&nbsp; &nbsp; <input type="Submit"> &nbsp; &nbsp; <input type="reset"> &nbsp; &nbsp;
		
		<b align="center"> <label> New User? </label> <a href ="user_registration.jsp"> <label> Register Here </label> </a></b>
		</div>
		</body>
