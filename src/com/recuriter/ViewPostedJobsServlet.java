...
@WebServlet("/ViewPostedJobsServlet")
public class ViewPostedJobsServlet extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String username = (String) session.getAttribute("recuriter");
			
		List<AddJob> list= RecuriterDao.getAllPostedJobs(username);
		...
		out.print("<tr><th>Job Role</th><th>Job Description</th><th>Company Name</th><th>Experience</th><th>Job Location</th><th>Skills</th><th>Salary</th>"
				+ "<th>Employment Type</th><th>Contact Person Name</th><th>Mobile Number</th><th>Email Address</th>"
				+ "<th>Job Posted By</th></tr>");
		for(AddJob e:list){
			out.print("<tr><td>"+e.getJobrole()+"</td><td>"+e.getJobdescription()+"</td><td>"+e.getCompany_name()+"</td><td>"+e.getExperience()+"</td>"
					+ "<td>"+e.getJob_location()+"</td><td>"+e.getSkills()+"</td>"
							...
							+ "<td>"+e.getEmail()+"</td><td>"+e.getJob_posted_by()+"</td></tr>");
